...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [179821.929501, 2702637.792636, 181810.649758, 2703763.968009], maxZoom: 20, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:3825',
...
map.getView().fit([179821.929501, 2702637.792636, 181810.649758, 2703763.968009], map.getSize());
